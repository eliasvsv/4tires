...
$articulo["img"]= $items[$i-1]->find('img[style="margin-left: 30px;"]',0)->src;
$sql = "insert into products1 (cod,name,price,link,img) values(0,'".$articulo["titulo"]."','".$articulo["precio"]."','".$articulo["link"]."','".$articulo["img"]."')" ;
echo $sql;
//$mysqli->query($sql);
