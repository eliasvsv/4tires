...
$url="https://www.impar.ro/ro/Anvelope/Camere-de-aer-c61c69.html?limit=500";
...
$sql="INSERT INTO `web`.`imparBatteries`(`id`,  `desc`,     `link`,          `image`, `price`,`categorie`,`data`) values(0,'".$desc."','".$link."','".$image."','".$price."','Camere de aer','')";
$mysqli->query($sql) or  trigger_error("Query Failed! SQL: $sql - Error: ".mysqli_error($mysqli), E_USER_ERROR);
}
?>