	...
	<div class="logoheader">
		...
		<div class="container vertical-center">
            ...
            <ul id="nav-tabs-wrapper" class="nav nav-tabs nav-tabs-horizontal">
              <li class="active"><a href="#anvelope" data-toggle="tab">Anvelope</a></li>
              <li><a data-toggle="tab" href="#jante">Jante</a></li>
            ...
            <div class="tab-content">
                <div role="tabpanel" class="tab-pane fade in active" id="anvelope">
                    <form name="searchForm" id="searchForm" action="search.php" method="get" class="form-inline">
                    				 					<div class="col20 form-group">
										<label for="latimeid" class="latime"></label>
										<div id="Latime" class="form-group" ></div>
									</div>									
									<div class="col20 form-group">
										<label for="inaltime" class="inaltime"></label>
										 <div id="Inaltime" class="form-group" >.col-md-1</div>
									</div>											
									<div class="col20 form-group">
										<label for="diametru" class="diametru"></label>
										 <div id="Radius" class="form-group"  >.col-md-1</div>
									</div>
									<span class="col20 text-center">
										<button  type="submit" class="btn btnBlack">Afiseaza rezultate</button>
									</span>						  
									<br class="clear">
						  </form>
                </div>
...
<br class="clear">
    ...
    <div id="results">
      <?php
        if(isset($_GET["Latime"])){
$test = new Models\Products();
$args["c"]=$_GET["Latime"];
$args["f"]=$_GET["Latime"];
$args["Latime"]=$_GET["Latime"];
$args["Inaltime"]=$_GET["Inaltime"];
$args["Radius"]=$_GET["Radius"];
echo call_user_func_array(array($test,"searchProducts"),$args);
}
      ?>
    </div>
    <!-- Modal -->
