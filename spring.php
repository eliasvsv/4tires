...
$tyre["profil"]=$pro;
$sql="insert into sprin(id,descrip,brand,seazon,speedIndex,loadIndex,profil,price,stock) values(0,'".$tyre["desc"]."','".$tyre["brand"]."','".$tyre["seazon"]."','".$tyre["speedIndex"]."','".$tyre["loadIndex"]."','".$tyre["profil"]."','".$tyre["price"]."','".$tyre["stock"]."') ";
